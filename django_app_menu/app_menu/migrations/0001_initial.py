    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('named_url', models.CharField(blank=True, help_text='Named url from your urls.py file', max_length=255, verbose_name='Named URL')),
                ('menu', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='items', to='app_menu.Menu', verbose_name='menu')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='items', to='app_menu.MenuItem', verbose_name='parent menu item')),
            ],
            options={
